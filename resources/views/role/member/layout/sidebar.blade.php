        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-success p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item">
                        <a class="nav-link {{ ($title==="Dashboard Member") ? 'active': '' }}" href="/dashboard">
                        <i class="fas fa-bank"></i>
                        <span>Dashboard</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ ($title==="Saldo Member") ? 'active': '' }}" href="/member/saldo">
                        <i class="fas fa-money-bill"></i>
                        <span>Saldo</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ ($title==="Ticket") ? 'active': '' }}" href="/member/ticket">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow">
                                    <a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#">
                                        ...
                                        <img class="border rounded-circle img-profile" src="{{ asset('storage/'.auth()->user()->profile) }}">
                                    ...
                                    <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in">
                                        ...
                                        {{-- <form action={{"/pengaturanprofile/".auth()->user()->id}} method="POST">
                                            @csrf
                                            <button type="submit" class="dropdown-item"><i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;pengaturanprofile</button>
                                        </form> --}}
