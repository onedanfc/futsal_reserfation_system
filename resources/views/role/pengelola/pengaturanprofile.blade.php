                        ...
                        <div class="card-body">
                            <form action="/pengaturanprofile/update" method="post">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="first_name"><strong>Password Lama</strong></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="last_name"><strong>Password Baru</strong></label>
                                            <input class="form-control" type="password" id="last_name" name="newpassword">
                                        </div>
                                        @error('newpassword')
                                            <div class="invalid-report">
                                                {{ $message }}
